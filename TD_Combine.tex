...
\paragraph{1. Search Generative Experience (SGE) / AI Overviews :}
\begin{itemize}
    \item Qu'est-ce que SGE et comment change-t-il la SERP ?
...
\begin{itemize}
    ...
    \item \textbf{Veille :} Suivez l'actualit\'{e} SGE/AI Overviews de Google --- comment \'{e}volue la SERP ?
\end{itemize}
