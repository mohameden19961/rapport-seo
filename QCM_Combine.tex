...
\begin{enumerate}
    \item Que signifie AI Overviews dans le contexte du SEO ?
    \begin{itemize}
    ...
    *(Réponse : B)*
    ...
    \item Google AI Overviews utilise l'IA générative pour :
    \begin{itemize}
    ...
    *(Réponse : B)*
    ...
    \item Google AI Overviews modifie la façon dont les utilisateurs interagissent avec :
    \begin{itemize}
        \item[A)] Les emails
        \item[B)] Les SERP
    ...
    *(Réponse : B)*
    ...
    \item Pour s'adapter aux AI Overviews, il faut :
    \begin{itemize}
        \item[A)] Ignorer l'IA
    ...
    *(Réponse : B)*
    ...
    \item L'IA générative dans Google AI Overviews synthétise les réponses à partir de :
    \begin{itemize}
    ...
    *(Réponse : B)*
    ...
    \item L'AI Overviews de Google utilise l'IA générative. Cette affirmation est-elle vraie ?
    \begin{itemize}
        \item[A)] Non
        \item[B)] Oui
    ...
    *(Réponse : B)*
    ...
    \item L'IA générative et Google AI Overviews transforment les SERP. Cette affirmation est-elle vraie ?
    \begin{itemize}
        \item[A)] Non
        \item[B)] Oui
