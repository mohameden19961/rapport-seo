...
\newcommand{\level}[1]{%
    \medskip\noindent
    \colorbox{gray!20}{\makebox[0.12\textwidth][c]{\sffamily\bfseries\small Niveau}}%
    \hspace{0.5em}%
    \ifnum#1=1
        \colorbox{googlegreen!30}{\sffamily\bfseries\small D\'ebutant}
    \fi
    \ifnum#1=2
        \colorbox{googleyellow!40}{\sffamily\bfseries\small Interm\'ediaire}
    \fi
    \ifnum#1=3
        \colorbox{googlered!30}{\sffamily\bfseries\small Avanc\'e}
    \fi
    \bigskip
}
  ...
  \begin{tikzpicture}
    \node[draw=cyan, draw opacity=0.35, fill=cyan!8, rounded corners=10pt,
      ...
      {\fontsize{9}{11}\selectfont\color{cyan}\textbf{%
       \textls[200]{RAPPORT DE RECHERCHE \& ANALYSE}}}
    };
  \end{tikzpicture}
...
% PLAN PÉDAGOGIQUE
% ============================================
\chapter*{Plan pédagogique}
\addcontentsline{toc}{chapter}{Plan pédagogique}

\section*{Organisation du module}
Le module de Référencement Web est structuré en séquences pédagogiques correspondant aux huit parties du manuel. Le tableau ci-dessous présente la répartition indicative des volumes horaires :
...
\hline
\textbf{Partie} & \textbf{Cours} & \textbf{TD/TP} & \textbf{Total} \\
\hline
I. Fondamentaux des moteurs de recherche & 4h & 2h & 6h \\
II. Indexation technique & 4h & 4h & 8h \\
III. SEO On-Page & 3h & 3h & 6h \\
IV. SEO Technique Avancé & 6h & 6h & 12h \\
V. SEO Off-Page & 3h & 2h & 5h \\
VI. SEO Spécialisé & 4h & 4h & 8h \\
VII. Mesure et Analyse & 3h & 3h & 6h \\
VIII. Stratégie et Tendances & 3h & 2h & 5h \\
\hline
\textbf{Total} & \textbf{30h} & \textbf{26h} & \textbf{56h} \\
\hline
\end{tabular}
\end{center}
...
\section*{Progression recommandée}
\begin{description}
    \item[Séquence 1 -- Semaines 1-2] Partie I : fondamentaux et histoire (6h)
    \item[Séquence 2 -- Semaines 3-4] Partie II : indexation et contrôle du crawling (8h)
    \item[Séquence 3 -- Semaines 5-6] Partie III : optimisation On-Page (6h)
    \item[Séquence 4 -- Semaines 7-9] Partie IV : SEO technique avancé (12h)
    \item[Séquence 5 -- Semaine 10] Partie V : SEO Off-Page (5h)
    \item[Séquence 6 -- Semaines 11-12] Partie VI : SEO spécialisé (8h)
    \item[Séquence 7 -- Semaine 13] Partie VII : mesure et analyse (6h)
    \item[Séquence 8 -- Semaine 14] Partie VIII : stratégie et tendances (5h)
\end{description}

\section*{Modalités d'évaluation}
\begin{itemize}
    \item \textbf{Contrôle continu} : Exercices pratiques hebdomadaires (30\% de la note finale)
    \item \textbf{Projet intermédiaire} : Audit SEO d'un site web réel (30\%)
    \item \textbf{Examen final} : Épreuve théorique et pratique (40\%)
\end{itemize}
...
\textit{Rapport rédigé dans le cadre de la formation}\\[0.2cm]
\textbf{Institut Supérieur du Numérique}\\[0.2cm]
\textit{Spécialité : Développement Web et Multimédia}\\[0.2cm]
\textit{Module : Référencement et Optimisation Web}\\[0.5cm]
\rule{0.5\textwidth}{0.5pt}\\[0.5cm]
